...
low_cutoff = 1800; % Minimum frequency of interest (Hz)
high_cutoff = 3800; % Maximum frequency of interest (Hz)
...
while true
    ...
    if (last_max_measurement(2) ~= current_max_measurement(2))
        ...
        volume = convert_f_to_V_typeB(current_max_measurement(2));
